...
if ( ! class_exists( 'Pizzaro' ) ) :
	...
	class Pizzaro {
		...
		public function scripts() {
			 ...
			 * Scripts
			 */
			wp_enqueue_script( 'pizzaro-navigation', get_template_directory_uri() . '/assets/js/navigation.js', array( 'jquery' ), '20120206', true );
			...
			wp_enqueue_script( 'pizzaro-js', get_template_directory_uri() . '/assets/js/scripts.js', array( 'jquery', 'bootstrap-js' ), $pizzaro_version, true );
