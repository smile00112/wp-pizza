...
//add_action( 'pizzaro_header_v1', 'pizzaro_header_info_flex_wrapper',                25 );
add_action( 'pizzaro_header_v1', 'pizzaro_header_info_wrapper',                29 );
add_action( 'pizzaro_header_v1', 'pizzaro_header_phone',                       30 );
add_action( 'pizzaro_header_v1', 'pizzaro_header_info_wrapper_close',          31 );
add_action( 'pizzaro_header_v1', 'pizzaro_primary_navigation',                 40 );
//add_action( 'pizzaro_header_v1', 'pizzaro_header_info_flex_wrapper_close',               53 );
