...
if ( ! function_exists( 'pizzaro_footer_store_timings' ) ) {
	...
	function pizzaro_footer_store_timings() {
		echo '<a style="color: #fff" href="/оплата">Оплата</a><br>';
		echo '<a style="color: #fff" href="/privacy-policy">Политика конфиденциальности</a><br>';
		echo '<a style="color: #fff" href="/условия-доставки">Условия-доставки</a><br />';
		echo '<a style="color: #fff" href="/возврат-товара">Возврат товара</a><br />';
		echo '<a style="color: #fff" href="/реквизиты">Реквизиты</a><br /><br />';
		
		$store_timings = apply_filters( 'pizzaro_footer_store_timings', array(
			/*'timing_1' => array(
				'label'  => '<a style="color: #fff" href="/оплата">Оплата</a>',
				'timing' => esc_html__( '', 'pizzaro' ),
			),
			'timing_2' => array(
				'label'  => '<a style="color: #fff" href="/privacy-policy">Политика конфиденциальности</a>',
				'timing' => esc_html__( '11:30 - 22:00', 'pizzaro' ),
			),
			'timing_3' => array(
				'label'  => '<a style="color: #fff" href="/реквизиты">Реквизиты</a>',
...
if ( ! function_exists( 'pizzaro_footer_contact_info' ) ) {
	...
	function pizzaro_footer_contact_info() {
		...
		<div class="footer-contact-info">
			...
			<div id="messicons2" class="messicons">
				<a href="https://wa.me/79080755844" target="_blank" class="whatsup"></a>
				<a href="https://t.me/Inst250Bot" target="_blank" class="telegram"></a>
				<a href="viber://chat?number=79080755844" target="_blank" class="viber"></a>
			</div>
			<div class="footer-applications">
			<div class="footer-applications gl">
					<a style="vertical-align: top;" href="https://play.google.com/store/apps/details?id=ru.rodnaya.dostavka" target="_blank" rel="nofollow"><img src="/wp-content/uploads/2021/02/icon-google.svg" title="Скачать в Google Play Market" alt="Скачать в Google Play"></a></div>
			<div class="footer-applications gl">
					<a href="https://apps.apple.com/ru/app/%D1%80%D0%BE%D0%B4%D0%BD%D0%B0%D1%8F-%D0%B4%D0%BE%D1%81%D1%82%D0%B0%D0%B2%D0%BA%D0%B0/id1534877300" target="_blank" rel="nofollow"><img src="/wp-content/uploads/2021/02/icon-app.svg" title="Скачать в App Store" alt="Скачать в App Store"></a></div>
			</div>
		</div>
		<?php endif;
	}
