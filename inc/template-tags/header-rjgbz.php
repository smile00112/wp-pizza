...
if ( ! function_exists( 'pizzaro_site_branding' ) ) {
	...
	function pizzaro_site_branding() {
		...
		<div class="site-branding">
			<a class="baur_mobile-logo"  href="https://rollkroll.ru/">
				<svg class="svg_logo-max" width="110" height="46" viewBox="0 0 110 46" fill="none" xmlns="http://www.w3.org/2000/svg">
