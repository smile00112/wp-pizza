...
$order_meta_source = $order->get_meta('order_meta_source');
...
<?php } ?>
	<div id="payment">
		<?php if ( $order->needs_payment() ) : ?>
			...
			<?php if( isset($_GET['mobileapp']) && !empty($_GET['mobileapp'])) { ?>
				
				<li class="wc_payment_method payment_method_rbspayment">
	<input id="payment_method_rbspayment" type="radio" class="input-radio" name="payment_method" value="rbspayment" checked="checked" data-order_button_text="">
...
<style>
.pizzaro-order-steps{display:none;}
#order_review{opacity:0;}
</style>
		<script>

  document.getElementById("place_order").click(); // Click on the checkbox
