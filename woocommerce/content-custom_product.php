...
<div class="custom-product <?php echo $preview_class; ?>" data-product_id="<?php echo $product->get_id(); ?>">
  ...
  <div class="custom-product--info">
    ...
    <div class="custom-product--description"><?php the_excerpt(); ?> <?=apply_filters('the_count_type', $product);?></div>
    <div class="custom-product--bottom">
      ...
      <div class="custom-product--bottom-right <? if( $product->is_type('simple') && empty($reqired_dops) ){?>dont-show-modal<?}?>">
        ...
        <div class="custom-product--catalog-product-counter" style="display:none;">
          <div class="product-counter" data-price="<?php echo $product->get_price(); ?>" data-dops_price="0" style="max-width: unset;  margin-bottom: 0;" >
              <div class="minus changer"><i class="fa fa-minus"></i></div>
			  <?=apply_filters('fake_qty', $product);?>
              <input type="number" disabled class="quantity qty catalog_simple_qty_changer" data-catalog_simple_qty_changer value="1" min="1"> 
